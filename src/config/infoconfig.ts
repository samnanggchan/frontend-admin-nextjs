...
export const booksInfoContent: InfobarContent = {
  title: 'Books Management',
  sections: [
    {
      title: 'Overview',
      description:
        'The Books Management page allows you to manage your books and book collections. This feature enables you to view, add, edit, and delete books within your library.',
      links: [
        {
    ...
    },
    {
      ...
      description:
        'To create a new book, click the "Add New" button. You will be prompted to enter a book title and description. Once created, you can view and manage your new book.',
      links: [
        {
